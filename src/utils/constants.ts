export const ASCII_CHAR_COUNT = 128;
export const DEFAULT_LOG_VALUE = -20;
export const MINIMUM_STRING_LENGTH = 3;

// Special character mappings from ASCII codes to display representations
export const ASCII_TO_DESCRIPTION: Map<number, [string, string]> = new Map([
  [0, ['[NUL]', 'null']],
...
export const DESCRIPTION_TO_ASCII: Map<string, number> = new Map(
  Array.from(ASCII_TO_DESCRIPTION.entries()).map(([key, [desc]]) => [desc, key])
);
...
export const NG_THRESHOLDS: readonly number[] = Object.freeze([
...
export const MAX_NG_THRESHOLD = -6.3;